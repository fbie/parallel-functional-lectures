...
\begin{frame}{Take-Aways From This Lecture}
  ...
  \pause{} \item Use arrays close to the leaves.
  \pause{} \item Leave scheduling to the built-in scheduler.
  \pause{} \item Use higher-order functions for re-usable solutions.
  \pause{} \item Make data structures immutable for thread-safety.
  \end{itemize}
\end{frame}
